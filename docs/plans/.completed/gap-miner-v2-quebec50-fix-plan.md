# Plan — Upstream fixes in `nam20485/gap-miner-v2-quebec50`

> Handoff document for an implementing agent. Source: the forensic analysis `gap-miner-v2-sierra46-forensic-analysis.md` (§9, §10) in the [`nam20485/gap-miner-v2-sierra46`](https://github.com/nam20485/gap-miner-v2-sierra46) repo. Target repo: [`nam20485/gap-miner-v2-quebec50`](https://github.com/nam20485/gap-miner-v2-quebec50) (the parent template that owns the `/gh-issue-tracking-init` skill as the canonical source of truth).

| | |
|---|---|
| **Plan** | Forensic-fixes upstream in gap-miner-v2-quebec50 |
| **Target repo** | `nam20485/gap-miner-v2-quebec50` |
...
- **Fixes applied upstream flow forward:** once W1–W4 merge into `gap-miner-v2-quebec50`, any repo cloned from the template afterward inherits them automatically.
...
1. Clone/fetch `nam20485/gap-miner-v2-quebec50` and `cd` into it.
...
The plan is done when, against `nam20485/gap-miner-v2-quebec50`:
...
4. [ ] A PR opened against `nam20485/gap-miner-v2-quebec50`'s default branch:
...
```text
You are implementing a fix plan in nam20485/gap-miner-v2-quebec50. The fix plan is:
  docs/plans/gap-miner-v2-quebec50-fix-plan.md
...
5. Open a PR against the default branch of nam20485/gap-miner-v2-quebec50:
